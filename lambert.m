...
% ADJUSTED FOR EML-COMPILATION 24/Dec/2009
    ...
    if m == 0   % parametro che permette di calcolare orbite che fanno più giri attorno al Sole prima di arrivare a destinazione...
        ... m=0: Trasferimento diretto (es. Terra -> Marte in 6-9 mesi)....
        ... m=1: La sonda fa un giro completo + un pezzo prima di arrivare
        y1 = log(y12(1)) - logt;
        y2 = log(y12(2)) - logt;
    else
        y1 = y12(1) - tf;
